...
extern void ext_Prsd(double **Theory, double *kin, int kin_dim, double *Pout, double alpa, double alpe, double sigma8_scaling, int Num,double b1,double b2,double bs2,double b3nl,double A,double Pnoise,double f,int mup,double sigmaP)
{
    double val,err;
    int i;
    double xmin[1]={-1};
    ...
    for (i=0; i<kin_dim; i++)
    {
        struct f_params2 f_par = {"2L-RPT",Num,0.,0.,sigma8_scaling,sigma8_scaling,alpa,alpe,Theory,"linear",
            b1,b2,bs2,b3nl,A,Pnoise,f,"Lorentzian","TNS10",mup,kin[i],sigmaP};
